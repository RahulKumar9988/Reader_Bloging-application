    ...
    <div><Navbar />
        <div className="flex justify-center w-full h-screen pt-8 bg-primary">
            <div className="max-w-screen-lg w-full">
                ...
                }} type="text" className=" bg-primary border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5  dark:border-gray-600 dark:placeholder-gray-400 dark:text-black dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Your Title">
                </input>
