...
import { SignupInput } from "@rahulrola/medium-common"
...
export const Auth = ({type}:{type:'signin'|'signup'})=>{
    ...
    const handleSubmit = async() => {
      try {
        ...
        if (response.data.status !== 200) alert("crying over spilt")
        else navigate("/blogs");
    ...
    return(
        <div className=" text-center flex flex-col justify-center items-center gap-10 h-full">
            ...
            <div className="flex flex-col gap-5 items-center">
             ...
             <Inputs label='Roxy@gmail.com' text='Email' type='email' onChange={(e)=>{
                setPostInputs({
                    ...postInputs,
             ...
             <Inputs label='' text='Password' type='password' onChange={(e)=>{
                setPostInputs({
                    ...postInputs,
